...
public abstract class AbstractConfigsManager<C> {
	...
	public void reload() {
		this.getLogger().info("Started registering {} from resources...", this.getConfigName());
		...
		this.getLogger().info("Registering finished, found: {}, registered: {}", foundConfigs.get(), registeredConfigs.get());
	}
}
